          ...
          <div className="about-text d-flex justify-content-between">
            ...
            <div>
              ...
              <p>
                ...
                Assumenda iure provident quo vitae debitis? Nostrum ullam
                debitis tempore fuga inventore ab, quis hic, non, porro nulla
                dignissimos eius? Autem, sit at? Saepe maxime nisi ea commodi?
                Illo labore quidem natus nam ut optio voluptate nulla deserunt.
              </p>
            </div>
          </div>
        </div>
        <div className="d-flex about-section justify-content-between">
          <div className="overflow-hidden about-count w-25">
